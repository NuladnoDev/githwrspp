...
GROUP_ADD_WELCOME_LINE2 = "Например @rsphhw_bot 158. Бот берёт информацию с оффициального сайта колледжа, информация там побликуется значительно позже чем распечатанные варианты в самом колледже. <i>Есть маленький шанс, что расписание может измениться раньше его публикации на офф. сайте. Сверяйте информацию с распечатанными вариантами.</i>"
HELP_TEXT = (
    "\n"
    "⌜Помощь по командам⌟ ✦\n\n"
